...
export const dummyFindings: Finding[] = [
  {
    ...
    steps: [
      "Navigate to the login page at https://app.acmecorp.com/login",
  ...
  },
  {
    ...
    steps: [
      "Navigate to https://app.acmecorp.com/search",
      "Enter the following payload in the search box: <script>alert(document.cookie)</script>",
      "Submit the search form",
      "Observe that the script executes and the cookie is displayed in an alert box",
    ],
    impact: [
  ...
  },
  {
    ...
    steps: [
      "Authenticate as a regular user and obtain a valid JWT token",
      "Send a GET request to /api/users/profile with the token",
      "Inspect the response body — passwordHash and isAdmin fields are present",
    ],
    impact: [
  ...
  },
  {
    ...
    steps: [
      "Send a request to https://app.acmecorp.com using a tool like curl or Burp Suite",
      "Inspect the response headers",
      "Observe that the above-mentioned security headers are not present",
    ],
    impact: [
